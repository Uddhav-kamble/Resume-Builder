import { Check, CheckIcon, Layout } from 'lucide-react'
...
const TemplateSelector = ({ selectedTemplate, onChange}) => {
  ...
  return (
    <div className='relative'>
        <button onClick={()=> setIsOpen(!isOpen)} className='flex items-center gap-1 text-sm text-blue-600 bg-linear-to-br from-blue-50 to-blue-100 ring-blue-300
