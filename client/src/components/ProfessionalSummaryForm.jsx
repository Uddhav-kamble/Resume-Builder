  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='mt-6'>
            ...
            focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors resize-none' placeholder='Write a compelling professional summary that highlights your key strengths and carrer objectives...'/>
